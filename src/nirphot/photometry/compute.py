...
class ComputePhotometry:
    def __init__(
        self, detection_filter, sci_images, wht_images, exposure_times, run=""
    ):
        ...
        self.detection_catalog = self._run_detection_catalog(
    ...
    def _run_detection_catalog(
        ...
        if segmentation_map is not None and not detection_mode:
            ...
            raise ValueError(
                "Provide either segmentation_map or enable detection_mode, not both."
            )
